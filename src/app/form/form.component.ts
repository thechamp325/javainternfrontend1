...
export class FormComponent{
 ...
 'Y', 2, 'Religion', 'Caste', 'DOB', 'Pan', 810903810, 9849849544, 'Official_Email', 'Personal_Email' );
                  ...
                  this.des2 = this.formBuilder.group({
                    ...
                    past_teaching:     ['', Validators.required],
                    past_industry:     ['', Validators.required],
                    past_research:     ['', Validators.required],
                    pt_stardate:     ['', Validators.required],
                    pt_enddate:     ['', Validators.required],
                    pi_startdate:     ['', Validators.required],
                    pi_enddate:     ['', Validators.required],
                    pr_startdate:     ['', Validators.required],
                    pr_enddate:     ['', Validators.required],
                  });
  ...
  onSubmit(){
    ...
    this.http.post('http://10.10.14.236:8080/api/pi/emp', this.EmpForm.value, ).subscribe(result => {alert(result)})
  ...
  Submit(){
    ...
    Submit3(){
      ...
      this.http.post('http://10.10.14.236:8080/api/pi/emp', this.des3.value, ).subscribe(result => {alert(result)})
    }

    
  Submit4(){
    console.log(this.des4.value);
    this.http.post('http://10.10.14.236:8080/api/pi/emp', this.des4.value, ).subscribe(result => {alert(result)})
  }
